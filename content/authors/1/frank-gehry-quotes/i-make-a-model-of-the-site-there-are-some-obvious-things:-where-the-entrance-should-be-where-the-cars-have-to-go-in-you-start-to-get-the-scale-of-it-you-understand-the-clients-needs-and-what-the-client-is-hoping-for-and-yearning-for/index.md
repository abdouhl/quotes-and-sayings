+++
author = "Frank Gehry"
title = "I make a model of the site. There are some obvious things: where the entrance should be, where the cars have to go in. You start to get the scale of it. You understand the client's needs, and what the client is hoping for and yearning for."
...
keywords = "I make a model of the site. There are some obvious things: where the entrance should be, where the cars have to go in. You start to get the scale of it. You understand the client's needs, and what the client is hoping for and yearning for.,frank gehry,frank gehry quotes,frank gehry quote,frank gehry sayings,frank gehry saying,quotes, sayings,quote, saying, motivation"
+++
