+++
author = "H. R. Mcmaster"
title = '''What we can afford least is to define the problem of future war as we would like it to be and, by doing so, introduce into our defense vulnerabilities based on self-delusion.'''
...
keywords = '''What we can afford least is to define the problem of future war as we would like it to be and, by doing so, introduce into our defense vulnerabilities based on self-delusion.,h. r. mcmaster,h. r. mcmaster quotes,h. r. mcmaster quote,h. r. mcmaster sayings,h. r. mcmaster saying,quotes, sayings,quote, saying, motivation'''
+++
