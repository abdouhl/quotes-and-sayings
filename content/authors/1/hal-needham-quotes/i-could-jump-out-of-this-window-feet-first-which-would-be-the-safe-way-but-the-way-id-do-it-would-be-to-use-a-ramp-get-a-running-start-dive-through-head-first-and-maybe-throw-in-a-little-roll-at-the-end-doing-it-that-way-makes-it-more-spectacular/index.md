+++
author = "Hal Needham"
title = '''I could jump out of this window feet first, which would be the safe way. But the way I'd do it would be to use a ramp, get a running start, dive through head first and maybe throw in a little roll at the end. Doing it that way makes it more spectacular.'''
...
keywords = '''I could jump out of this window feet first, which would be the safe way. But the way I'd do it would be to use a ramp, get a running start, dive through head first and maybe throw in a little roll at the end. Doing it that way makes it more spectacular.,hal needham,hal needham quotes,hal needham quote,hal needham sayings,hal needham saying,quotes, sayings,quote, saying, motivation'''
+++
