+++
author = "Hank Green"
title = "The problem is, education in America is sub-optimal because it is an impossible thing to optimize. It necessarily has to be local because different schools face different problems. There are no one-size-fits-all solutions."
...
keywords = "The problem is, education in America is sub-optimal because it is an impossible thing to optimize. It necessarily has to be local because different schools face different problems. There are no one-size-fits-all solutions.,hank green,hank green quotes,hank green quote,hank green sayings,hank green saying,quotes, sayings,quote, saying, motivation"
+++
