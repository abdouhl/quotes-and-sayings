...
title = '''The infrastructure we provide is the same in a remote town in Africa or New York or an archipelago in Sweden: we use the same system, and the chips inside the phone are the same.'''
...
keywords = '''The infrastructure we provide is the same in a remote town in Africa or New York or an archipelago in Sweden: we use the same system, and the chips inside the phone are the same.,hans vestberg,hans vestberg quotes,hans vestberg quote,hans vestberg sayings,hans vestberg saying,quotes, sayings,quote, saying, motivation'''
+++
