+++
author = "Harper Reed"
title = "I can only speak to the Democrat side, but for the Democrats, everything is aggressively measured, and what that means is if you're going to use Snapchat, you're going to use it for a reason, not just for fun."
...
keywords = "I can only speak to the Democrat side, but for the Democrats, everything is aggressively measured, and what that means is if you're going to use Snapchat, you're going to use it for a reason, not just for fun.,harper reed,harper reed quotes,harper reed quote,harper reed sayings,harper reed saying,quotes, sayings,quote, saying, motivation"
+++
