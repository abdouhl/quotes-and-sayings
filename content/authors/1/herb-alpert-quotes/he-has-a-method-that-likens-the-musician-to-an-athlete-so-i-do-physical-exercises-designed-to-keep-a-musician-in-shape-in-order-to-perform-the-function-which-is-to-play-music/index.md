+++
author = "Herb Alpert"
title = '''He has a method that likens the musician to an athlete, so I do physical exercises designed to keep a musician in shape in order to perform the function, which is to play music.'''
...
keywords = '''He has a method that likens the musician to an athlete, so I do physical exercises designed to keep a musician in shape in order to perform the function, which is to play music.,herb alpert,herb alpert quotes,herb alpert quote,herb alpert sayings,herb alpert saying,quotes, sayings,quote, saying, motivation'''
+++
